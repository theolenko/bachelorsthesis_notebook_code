...
# Dateien
META_FILE   = os.path.join(os.path.dirname(__file__), 'Thueringen_Meta.json')
OUTPUT_FILE = os.path.join(os.path.dirname(__file__), 'Thueringen_Data.json')
...
def main():
    ...
    for ent in entries:
        ...
        # Annahme: ElementID ist direkte URL
